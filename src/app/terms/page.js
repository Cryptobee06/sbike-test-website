...
export default function Termssection() {
  ...
  const sections = [
    ...
    },
    {
      ...
      paragraphs: [
        "All content published on TreadmillReviews, including but not limited to text, graphics, logos, product comparisons, images, audio clips, data compilations, digital downloads, and software, is the exclusive property of TreadmillReviews or its content suppliers and is protected by international copyright, trademark, and intellectual property laws. You may not reproduce, republish, distribute, display, sell, license, or otherwise exploit any content from this website without our express prior written consent. We grant you a limited, non-exclusive, non-transferable license to access and use the Site solely for personal and non-commercial purposes. You agree not to use any automated tools such as bots, spiders, or crawlers to access or copy any part of our content without explicit permission.",
        "Any trademarks, service marks, logos, or trade names displayed on the Site, whether registered or unregistered, are the property of TreadmillReviews or third-party partners. Nothing on this Site grants you the right or license to use any of our marks without prior consent. You may, however, share links to our public pages through personal blogs or social media with proper credit and without modifying the original content. Any use of our content in violation of this agreement may result in legal action, including civil and criminal penalties.",
        "We respect the intellectual property rights of others and expect our users to do the same. If you believe that any content on the Site infringes your copyright or other rights, please notify us by email at legal@treadmillreviews.com. Provide sufficient detail for us to investigate and, if necessary, take appropriate action, including content removal or account restriction if applicable."
      ]
    },
    {
