...
export default function Footer() {
  ...
  // Determine base path for links based on current locale
  const getBasePath = () => {
    return locale === 'de' ? '/de' : '';
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">
              {locale === 'en' ? 'Quick Links' : 'Schnelle Links'}
            </h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link href={`${getBasePath()}/guide`} className="text-gray-300 hover:text-primary-400 transition-colors">
                  {t('guide')}
                </Link>
              </li>
              <li>
                <Link href={`${getBasePath()}/blog`} className="text-gray-300 hover:text-primary-400 transition-colors">
                  {t('blog')}
                </Link>
              </li>
              <li>
                <Link href={`${getBasePath()}/about`} className="text-gray-300 hover:text-primary-400 transition-colors">
                  {t('about')}
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              ...
              {/* <li>
                <a  className="text-gray-300 hover:text-primary-400 transition-colors">
                  {locale === 'en' ? 'Cookie Policy' : 'Cookie-Richtlinie'}
                </a>
              </li>
              <li>
                <a  className="text-gray-300 hover:text-primary-400 transition-colors">
